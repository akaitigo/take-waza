 ...
 * @returns {string}
 */
export function decompose_steps_json(graph_json) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(graph_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.decompose_steps_json(ptr0, len0);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function generate_pattern_json(pattern_name, width, thickness, count) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(pattern_name, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.generate_pattern_json(ptr0, len0, width, thickness, count);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function list_patterns() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.list_patterns();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
 ...
 * @param {number} new_thickness
 * @returns {string}
 */
export function transform_pattern_json(graph_json, new_width, new_thickness) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(graph_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.transform_pattern_json(ptr0, len0, new_width, new_thickness);
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
